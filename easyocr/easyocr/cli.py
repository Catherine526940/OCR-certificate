...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Force OCR to recognize only subset of characters",
    )
    parser.add_argument(
        "--blocklist",
        type=str,
    ...
    parser.add_argument(
        ...
        type=list,
        default=None,
        help="Allow OCR to rotate each text box and return the one with the best confident score. Eligible values are 90, 180 and 270. For example, try [90, 180 ,270] for all possible text orientations.",
    )
    parser.add_argument(
        "--paragraph",
        type=bool,
